...
SELECT MAX (PURCHASE_AMOUNT) AS MAXIMUM_purchase_amount, CUSTOMER_ID FROM ORDERS GROUP BY CUSTOMER_ID;
...
SELECT MAX (PURCHASE_AMOUNT) AS MAXIMUM_purchase_amount, SALESMAN_ID, ORDER_DATE FROM ORDERS 
